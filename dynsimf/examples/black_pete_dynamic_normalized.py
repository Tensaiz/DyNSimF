...
if __name__ == "__main__":
    ...
    init_I = np.random.normal(0, 0.1, constants['N'])
    ...
    def update_removal_p():
        model.constants['link_removal_p'] = 0.0005
        return {}
    ...
    # update_removal_p_update = Update(update_removal_p)
    # model.add_scheme(Scheme(lambda graph: graph.nodes, {'args': {'graph': model.graph}, 'lower_bound': 15000, 'upper_bound': 15001, 'updates': [update_removal_p_update]}))
    ...
    visualization_config = {
        ...
        'show_plot': False,
        'directed': False,
        'plot_output': '../animations/HIOM_dynamic_meeting2.gif',
